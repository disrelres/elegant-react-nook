    ...
    <main className="flex-grow container mx-auto px-4 py-8 dark:bg-gray-900">
      ...
      >
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4 text-green-600 dark:text-green-400 font-['Verdana']">
            Virtual Dice Roller
          </h1>
          ...
          <Separator className="my-8 bg-green-600 dark:bg-green-800 opacity-20" />
        </div>
