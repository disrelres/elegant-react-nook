    ...
    <div className="bg-white/70 backdrop-blur-md p-6 rounded-lg shadow-sm mb-8 border border-black">
      <div className="flex flex-col gap-6">
        <div className="space-y-3">
          <p className="text-center font-['Verdana'] text-black mb-2">Please select Programs or Organizations to begin your search:</p>
          <div className="flex gap-4 justify-center">
            <button
              className={`py-2 px-8 rounded-md font-['Verdana'] border border-black transition-colors ${
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <select
            className="p-2 border rounded-md font-['Verdana'] text-black w-full"
            value={serviceType}
          ...
          <div className="relative">
            <input
              ...
              className="w-full p-2 pe-10 border rounded-md font-['Verdana'] text-black"
              onKeyDown={(e) => e.key === 'Enter' && handleSearch()}
            />
            <button
              onClick={handleSearch}
              className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#044bab] transition-colors"
              aria-label="Search"
            >
